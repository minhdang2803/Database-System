...
Validator.isRequired = function(selector, message) {
    return {
        selector: selector,
        test: function(value) {
            return value ? undefined : message || 'This field must be filled'
        }
    };
}
...
Validator.isEmail = function(selector, message) {
    return {
        ...
        test: function(value) {
            ...
            return regex.test(value) ? undefined : message || 'This is not email format';
        }
    };
}
...
Validator.phoneCheck = function(selector, message) {
    return {
        ...
        test: function(value) {
            ...
            return regex.test(value) ? undefined : message || 'This is not phone number';
        }
    }
}
...
Validator.isNumber = function(selector, message) {
    return {
        ...
        test: function(value) {
            var regex = /^\d+$/;
            return regex.test(value) ? undefined : message || 'Phone must be number';
        }
    }
}